...
import { Round, Submission, Participant, Score } from "@/types";
    ...
    <Card className="bg-zinc-900 border-yellow-500/30 ring-1 ring-yellow-500/20">
      <CardHeader>
        ...
        <CardDescription className="text-zinc-400">
          Award points to each participant for Round {activeRound.round_number}. You may also eliminate participants.
        </CardDescription>
      </CardHeader>
                ...
                <div className="flex items-center gap-4 flex-wrap sm:flex-nowrap">
                  <div className="flex items-center gap-2">
                    ...
                    <Input 
                      ...
                      type="number" 
                      min="0" max="100" 
                      className="w-20 bg-zinc-900 border-zinc-700 h-9"
